...
public class TowDbContext: DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TowModelMount>().HasData(
            ...
            new TowModelMount { Id = 5, Name = "Black Dragon", Movement = 6, WeaponSkill = 6, Strength = 7, ToughnessAdded = 3, WoundsAdded = 6, Initiative = 4, Attacks = 6, PointsCostAdded = 280, ModelTroopType = TowModelTroopType.Beheamoth, Faction = darkEvlesFaction },
            new TowModelMount { Id = 6, Name = "Cauldron Of Blood", Movement = 2, WeaponSkill = null, Strength = 5, Toughness = 5, Wounds = 5, Initiative = null, Attacks = null, PointsCostAdded = 150, ModelTroopType = TowModelTroopType.HeavyChariot, Faction = darkEvlesFaction, 
