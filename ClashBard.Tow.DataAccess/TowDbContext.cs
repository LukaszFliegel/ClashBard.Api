...
public class TowDbContext: DbContext
{
    ...
    public DbSet<TowModelSpecialRule> TowModelSpecialRules { get; set; }

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<TowFaction>().HasData(
            ...
            new TowFaction { Id = 10, Name = "Dark Elves" },
        ...
        modelBuilder.Entity<TowModel>().HasData(
            new TowModel { Id = 1, Name = "Dark Elf Dreadlord", Movement = 5, WeaponSkill = 7, BallisticSkill = 7, Strength = 4, Toughness = 3, Wounds = 3, Initiative = 6, Attacks = 4, Leadership = 10, FactionId = 10 },
            new TowModel { Id = 2, Name = "Dark Elf Master", Movement = 5, WeaponSkill = 6, BallisticSkill = 6, Strength = 4, Toughness = 3, Wounds = 2, Initiative = 5, Attacks = 3, Leadership = 9, FactionId = 10 },
            new TowModel { Id = 3, Name = "Supreme Sorceress", Movement = 5, WeaponSkill = 4, BallisticSkill = 4, Strength = 3, Toughness = 3, Wounds = 3, Initiative = 5, Attacks = 2, Leadership = 8, FactionId = 10 },
            new TowModel { Id = 4, Name = "Sorceress", Movement = 5, WeaponSkill = 4, BallisticSkill = 4, Strength = 3, Toughness = 3, Wounds = 2, Initiative = 4, Attacks = 1, Leadership = 8, FactionId = 10 },
            new TowModel { Id = 5, Name = "High Beastmaster", Movement = 5, WeaponSkill = 7, BallisticSkill = 7, Strength = 4, Toughness = 3, Wounds = 3, Initiative = 5, Attacks = 3, Leadership = 9, FactionId = 10 },
            new TowModel { Id = 6, Name = "Death Hag", Movement = 5, WeaponSkill = 6, BallisticSkill = 6, Strength = 4, Toughness = 3, Wounds = 2, Initiative = 7, Attacks = 3, Leadership = 8, FactionId = 10 },
            new TowModel { Id = 7, Name = "Khainite Assassin", Movement = 5, WeaponSkill = 8, BallisticSkill = 7, Strength = 4, Toughness = 3, Wounds = 2, Initiative = 7, Attacks = 3, Leadership = 8, FactionId = 10 },
            new TowModel { Id = 8, Name = "Dark Elf Warrior", Movement = 5, WeaponSkill = 4, BallisticSkill = 4, Strength = 3, Toughness = 3, Wounds = 1, Initiative = 4, Attacks = 1, Leadership = 8, FactionId = 10 },
            new TowModel { Id = 9, Name = "Repeater Crossbowman", Movement = 5, WeaponSkill = 4, BallisticSkill = 4, Strength = 3, Toughness = 3, Wounds = 1, Initiative = 4, Attacks = 1, Leadership = 8, FactionId = 10 },
            new TowModel { Id = 10, Name = "Black Guard of Naggarond", Movement = 5, WeaponSkill = 3, BallisticSkill = 0, Strength = 4, Toughness = 3, Wounds = 2, Initiative = 2, Attacks = 1, Leadership = 6, FactionId = 10 },
            new TowModel { Id = 11, Name = "Scourgerunner Chariot", Movement = 2, WeaponSkill = 0, BallisticSkill = 0, Strength = 0, Toughness = 6, Wounds = 2, Initiative = 0, Attacks = 0, Leadership = 0, FactionId = 10 },
            new TowModel { Id = 12, Name = "Beastmaster Crew", Movement = 5, WeaponSkill = 4, BallisticSkill = 4, Strength = 3, Toughness = 3, Wounds = 1, Initiative = 4, Attacks = 1, Leadership = 8, FactionId = 10 },
            new TowModel { Id = 13, Name = "Dark Steed", Movement = 9, WeaponSkill = 3, BallisticSkill = 0, Strength = 3, Toughness = 3, Wounds = 1, Initiative = 4, Attacks = 1, Leadership = 0, FactionId = 10 },
            new TowModel { Id = 14, Name = "Cold One Chariot", Movement = 2, WeaponSkill = 0, BallisticSkill = 0, Strength = 0, Toughness = 5, Wounds = 4, Initiative = 0, Attacks = 0, Leadership = 0, FactionId = 10 },
            new TowModel { Id = 15, Name = "Knight Charioteer", Movement = 5, WeaponSkill = 5, BallisticSkill = 4, Strength = 4, Toughness = 3, Wounds = 1, Initiative = 5, Attacks = 1, Leadership = 9, FactionId = 10 },
            new TowModel { Id = 16, Name = "Cold One", Movement = 7, WeaponSkill = 3, BallisticSkill = 0, Strength = 4, Toughness = 3, Wounds = 1, Initiative = 2, Attacks = 2, Leadership = 0, FactionId = 10 },
            new TowModel { Id = 17, Name = "Black Dragon", Movement = 6, WeaponSkill = 6, BallisticSkill = 0, Strength = 7, Toughness = 3, Wounds = 6, Initiative = 3, Attacks = 5, Leadership = 7, FactionId = 10 },
            new TowModel { Id = 18, Name = "Manticore", Movement = 6, WeaponSkill = 5, BallisticSkill = 0, Strength = 5, Toughness = 1, Wounds = 4, Initiative = 3, Attacks = 5, Leadership = 7, FactionId = 10 },
            new TowModel { Id = 19, Name = "War Hydra", Movement = 6, WeaponSkill = 4, BallisticSkill = 0, Strength = 5, Toughness = 5, Wounds = 5, Initiative = 3, Attacks = 2, Leadership = 6, FactionId = 10 },
            new TowModel { Id = 20, Name = "Beastmaster Handlers", Movement = 6, WeaponSkill = 4, BallisticSkill = 4, Strength = 3, Toughness = 3, Wounds = 2, Initiative = 4, Attacks = 1, Leadership = 8, FactionId = 10 },
            new TowModel { Id = 21, Name = "Bloodwrack Medusa", Movement = 7, WeaponSkill = 5, BallisticSkill = 5, Strength = 4, Toughness = 4, Wounds = 4, Initiative = 5, Attacks = 3, Leadership = 7, FactionId = 10 },
            new TowModel { Id = 22, Name = "Kharibdyss", Movement = 6, WeaponSkill = 5, BallisticSkill = 0, Strength = 7, Toughness = 5, Wounds = 5, Initiative = 3, Attacks = 5, Leadership = 6, FactionId = 10 },
            new TowModel { Id = 23, Name = "Repeater Bolt Thrower", Movement = 0, WeaponSkill = 0, BallisticSkill = 0, Strength = 0, Toughness = 6, Wounds = 2, Initiative = 0, Attacks = 0, Leadership = 0, FactionId = 10 },
            new TowModel { Id = 24, Name = "Dark Elf Crew", Movement = 5, WeaponSkill = 4, BallisticSkill = 4, Strength = 3, Toughness = 3, Wounds = 2, Initiative = 4, Attacks = 2, Leadership = 8, FactionId = 10 }
        );

        modelBuilder.Entity<TowModelSpecialRule>().HasData(
