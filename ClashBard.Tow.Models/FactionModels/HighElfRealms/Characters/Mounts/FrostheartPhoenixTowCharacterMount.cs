...
public class FrostheartPhoenixTowCharacterMount : TowModelCharacterMount
{
    private static int pointsCost = 200;
    private static HighElvesTowModelMountType modelType = HighElvesTowModelMountType.FrostheartPhoenix;
    ...
    public FrostheartPhoenixTowCharacterMount(TowObject owner) : this(owner, m: 2, ws: 5, bs: null, s: 5, t: 5, toughnessAdded: null, w: 4, woundsAdded: null, i: 4, a: 2, ld: 8)
    {
    }

    protected FrostheartPhoenixTowCharacterMount(TowObject owner, int? m, int? ws, int? bs, int s, int? t, int? toughnessAdded, int? w, int? woundsAdded, int? i, int? a, int? ld)
        : base(owner, modelType, m, ws, bs, s, t, toughnessAdded, w, woundsAdded, i, a, ld, pointCost: pointsCost, troopType, faction, baseSizeWidth, baseSizeLength, armourValue)
    {
        ...
        // Phoenix specific abilities like phoenix reborn and blizzard aura would need custom special rules
    }
}
