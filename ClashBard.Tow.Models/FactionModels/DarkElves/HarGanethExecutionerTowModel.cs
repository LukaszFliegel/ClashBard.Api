...
public class HarGanethExecutionerTowModel : TowModel
{
    ...
    public HarGanethExecutionerTowModel(TowObject owner) : this(owner, m: 5, ws: 5, bs: 4, s: 4, t: 3, w: 1, i: 5, a: 1, ld: 9)
    {
    ...
    protected HarGanethExecutionerTowModel(TowObject owner, int? m, int ws, int bs, int s, int t, int w, int i, int a, int ld) 
        : base(owner, DarkElvesTowModelType.HarGanethExecutioners, m, ws, bs, s, t, w, i, a, ld, pointCost: pointsCost, TowModelTroopType.HeavyInfantry, new DarkElvesTowFaction(), 25, 25, minUnitSize: 10)
    {
        // special rules
