...
public class PendantOfKhaelethTowTalisman : TowEnchantedItem, IWardSaveImprover
{
    ...
    public PendantOfKhaelethTowTalisman(TowObject owner) : base(owner, TowDarkElfMagicItemType.PendantOfKhaeleth, points)
    {
...
public class PendantOfKhaelethRules : TowSpecialRule
{
