...
public class Regeneration4Plus : TowSpecialRule
{
    private static string ShortDescription = "Regeneration (4+)";
    ...
    public Regeneration4Plus()
        : base(TowSpecialRuleType.Regeneration4Plus,
            ShortDescription,
            LongDescription,
