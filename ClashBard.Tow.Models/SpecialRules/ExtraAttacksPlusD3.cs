...
public class ExtraAttacksPlusD3 : TowSpecialRule
{
    private static string ShortDescription = "+D3 attacks";
    ...
    public ExtraAttacksPlusD3()
        : base(TowSpecialRuleType.ExtraAttacksPlusD3,
            ShortDescription,
            LongDescription,
