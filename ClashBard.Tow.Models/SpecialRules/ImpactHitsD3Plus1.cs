...
public class ImpactHitsD3Plus1 : TowSpecialRule
{
    private static string ShortDescription = "D3+1 impact hits";
    ...
    public ImpactHitsD3Plus1()
        : base(TowSpecialRuleType.ImpactHitsD3Plus1,
            ShortDescription,
            LongDescription,
