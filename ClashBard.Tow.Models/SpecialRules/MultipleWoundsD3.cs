...
public class MultipleWoundsD3 : TowSpecialRule
{
    private static string ShortDescription = "Causes D3 wounds";
    ...
    public MultipleWoundsD3()
        : base(TowSpecialRuleType.MultipleWoundsD3,
            ShortDescription,
            LongDescription,
