...
public class BloodshieldOfKhaine : TowSpecialRule
{
    private static string ShortDescription = "Blessing of Khaine: 5+ WSv";
    ...
    public BloodshieldOfKhaine()
        : base(TowSpecialRuleType.BloodshieldOfKhaine,
            ShortDescription,
            LongDescription,
            printName: false)
    {
