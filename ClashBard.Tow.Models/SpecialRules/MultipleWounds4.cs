...
public class MultipleWounds4 : TowSpecialRule
{
    private static string ShortDescription = "Causes 4 wounds";
    ...
    public MultipleWounds4()
        : base(TowSpecialRuleType.MultipleWounds4,
            ShortDescription,
            LongDescription,
